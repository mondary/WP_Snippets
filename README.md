...
- **Barre d'actions `v4`** — une barre sticky discrète regroupe Google News, Flux RSS, Newsletter, Diaporama plein écran, Articles programmés, Statistiques, Ko-fi et Retour en haut. Elle reste lisible sur desktop et se défile horizontalement sur mobile. Voir `snippets/canonical/FRONTEND 🌸 FAB - Hub Flottant - v4.php`.
