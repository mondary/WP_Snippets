<?php
/*
 * Display name: FRONTEND 📊 STATS - Site Stats Page - 2026.09.11
 * Scope: global
 */
...
function clm_stats_render_html($data) {
    ...
    .ss-version{position:absolute;top:1.25rem;right:1.5rem;font-size:.75rem;font-weight:600;color:var(--muted);letter-spacing:.06em;text-align:right;line-height:1.6}
    </style>
    ...
    <div class="ss-version" title="Site Stats Page · Live Cursors">Stats v2026.09.11<br>Cursor v<?php echo esc_html($cursor_ver); ?></div>
    </div>
    </div>
    <script>
    (function(){
