<?php
/*
 * Display name: ADMIN ✏️ EDITOR - Close Sidebars On Open - v2
 * Scope: admin
 */
...
/**
 * Ferme les volets gauches de l'éditeur Gutenberg à l'ouverture d'un article :
 * - la vue liste (panneau gauche)
 * - l'inserteur de blocs (panneau gauche)
 * Le volet Réglages (droite : Paramètres article/bloc) reste ouvert.
