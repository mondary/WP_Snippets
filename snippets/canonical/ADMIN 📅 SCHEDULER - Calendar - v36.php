<?php
/*
 * Display name: ADMIN 📅 SCHEDULER - Calendar - v36
 * Scope: global
 */
...
function generate_scheduled_posts_calendar_alpha() {
    ...
    <div class="wrap">
        <div class="calendar-hero">
            <h1>Calendrier <span style="font-size:0.55em;font-weight:600;color:#2271b1;vertical-align:middle;background:#e8f0fe;padding:2px 8px;border-radius:999px;margin-left:6px;">v35</span></h1>
