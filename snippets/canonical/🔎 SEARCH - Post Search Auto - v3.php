 ...
 * Changelog v3: Fusion Search Auto + Search Custom, fix bug saisie continue
 ...
 * Fichier: ACTIVE__global__post-search-auto__v3__src-wp_snippets_online_current.php
 * Path: WP_Snippets_FINAL_CLEAN/canonical/ACTIVE__global__post-search-auto__v3__src-wp_snippets_online_current.php
...
/* SCRIPT AUTO (fusionné et corrigé depuis Search Auto v2) */
add_action('wp_footer', function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        document.addEventListener('keydown', function (e) {
            ...
            // Empêche de réouvrir si déjà en cours d'ouverture
            ...
            if (searchButton) {
                ...
                setTimeout(() => {
                    ...
                    if (input) {
                        ...
                        // Libère IMMÉDIATEMENT après focus pour permettre la saisie continue
                        searchAlreadyOpened = false;
                    } else {
                        // Fallback : si le champ n'existe pas, libère le flag
                        searchAlreadyOpened = false;
                    }
                }, 300);

                // Timeout de sécurité : libère le flag si jamais le focus échoue
                setTimeout(() => { searchAlreadyOpened = false; }, 1000);
            }
        });
    });
    </script>
