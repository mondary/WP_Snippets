<?php
/*
 * Display name: FRONTEND 🌸 FAB - Hub Flottant - v18
 * Scope: global
 */
 ...
 * Historique : v18 = morph résistant aux optimiseurs de scripts (WP Rocket,
 * Autoptimize, Rocket Loader…) qui décalent GSAP après le script inline :
 * échange instantané layer<->cube en repli si GSAP absent, et
...
function mdhub_print_styles() {
    ...
    <style>
        ...
        .mdhub-main-icons { position: relative; display: block; flex: 0 0 auto; width: 30px; height: 30px; }
...
function mdhub_render() {
    ...
    (function () {
        ...
        function morphBurger(open) {
            ...
            /* Repli : GSAP pas encore là — échange immédiat des formes */
