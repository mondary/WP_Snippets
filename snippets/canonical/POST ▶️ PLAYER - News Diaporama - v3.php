<?php
/*
 * Display name: POST ▶️ PLAYER - News Diaporama - v3
 * Scope: global
 */
...
/*
 * Title: Floating Play Button -> Fullscreen News Diaporama (v3)
 * Description: v3 - bouton play bleu. Diaporama plein ecran des articles.
 ...
 *              v3 : les URL https:// en texte brut dans les articles sont
 *              rendues cliquables (le filtre the_content "External Clickable"
 *              ne tourne pas en contexte REST car is_singular() est faux),
 *              les liens du contenu ouvrent dans un nouvel onglet, et a la
 *              fermeture du diaporama on navigue vers le dernier article
 *              consulte au lieu de revenir a la page de lancement.
...
function news_player_render_markup() {
    ...
    (function () {
        ...
        function render() {
            ...
            // v3 : URL du contenu cliquables + ouverture nouvel onglet
        ...
        // v3 : echappe du texte pour insertion via innerHTML
        function escHtml(s) {
        ...
        // v3 : rend cliquables les URL http(s):// en texte brut et force
        // tous les liens du contenu en nouvel onglet (le filtre the_content
        // "External Clickable" ne s'applique pas en contexte REST)
        ...
        function close() {
            // v3 : a la fermeture, on navigue vers le dernier article consulte
            var p = posts[current];
