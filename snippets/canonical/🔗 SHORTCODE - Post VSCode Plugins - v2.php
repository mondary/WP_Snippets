 ...
 * Source path: WP_Snippets_Online_Current/active/global/086__id-146__post-vscode-plugins.php
 * Display name: POST - VScode plugins
 * Scope: global
 * Online snippet: oui
 * Online active: oui
 * Online ID: 146
 * Online modified: 2026-01-19 09:16:05
 * Online revision: 1
 * Exact duplicate group: oui (979cf3363ead…, 2 membres)
 * Canonical exact group ID: 109
 * Version family: DUP POST - VScode plugins (1 variantes)
 * Version: v2
 * Recommended latest in family: WP_Snippets_Online_Current/active/global/086__id-146__post-vscode-plugins.php
 * Is family latest: oui
 * Canonical reasons: exact-group-canonical, protected-online-active
 * Features: shortcode
 * Dependances probables: WordPress core hooks
 * Hooks WP: aucun
 * Fonctions clefs: vscode_extensions_shortcode, get_vscode_extensions_from_content, get_vscode_extension_data, fetch_extension_data, display_vscode_extension_tile, get_vscode_tiles_styles
 * Shortcodes: vscode_extensions
 * Lignes / octets (brut): 291 / 9599
 * Hash code normalise (sha256): 979cf3363ead54ae5e8f34df82a4f222b863df47affb1fa7e37a2821b07cc12d
 * Genere le (UTC): 2026-02-24T16:05:10+00:00
 */

/* CLM-FEATURES-DESCRIPTION:START
 * Fichier: ACTIVE__global__post-vscode-plugins__v2__src-wp_snippets_online_current.php
 * Path: WP_Snippets_FINAL_CLEAN/canonical/ACTIVE__global__post-vscode-plugins__v2__src-wp_snippets_online_current.php
 * Resume fonctionnalites: shortcode WordPress, UI frontend (CSS/HTML), 6 fonction(s) clef
 * Features detectees: shortcode, css-ui, cache-transient
 * Dependances probables: WordPress core hooks
 * Hooks WP: aucun
 * Fonctions clefs: vscode_extensions_shortcode, get_vscode_extensions_from_content, get_vscode_extension_data, fetch_extension_data, display_vscode_extension_tile, get_vscode_tiles_styles
 * Shortcodes: vscode_extensions
 * APIs WP detectees: add_shortcode, get_vscode_extensions_from_content, get_vscode_tiles_styles, get_vscode_extension_data, get_transient, wp_remote_get, is_wp_error, get_error_message, wp_remote_retrieve_body, wp_remote_retrieve_response_code
 * Signatures contenu: inline-style, html-markup
 * Lignes / octets: 305 / 10135
 * Empreinte code (sha256): 0e5d698ee74d6218a8048f7fdf9bf32d269cfcca1c7d794b13826932fbab4acd
 ...
 * Clusters secondaires: performance_optimization, admin_ui_settings
 * Domaine: shortcode
 * Confiance: low
 * Scores (top): shortcode_preview=5, performance_optimization=5, admin_ui_settings=4, shortcode_other=2, frontend_ui_widget=2
