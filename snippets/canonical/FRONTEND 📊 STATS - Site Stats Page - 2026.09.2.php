<?php
/*
 * Display name: FRONTEND 📊 STATS - Site Stats Page - 2026.09.2
 * Scope: global
 */
...
function clm_stats_render_html($data) {
    ...
    (function(){
      ...
      function drawChart(el,data,mx){
        if(!el||!data.length){if(el)el.innerHTML='<svg viewBox="0 0 840 300"><text x="420" y="160" text-anchor="middle" fill="var(--muted)" font-size="14">Aucune donnée</text></svg>';return}
        ...
        el.innerHTML='<svg viewBox="0 0 840 300" aria-hidden="true">'+h+'</svg>';
