<?php
/*
 * Display name: FRONTEND 📊 CURSOR - Live Cursors - 2026.09.13
 * Scope: global
 */
...
function clm_cursor_footer_js() {
    ...
    global $wpdb;
    $year_total = (int) $wpdb->get_var($wpdb->prepare("SELECT SUM(views) FROM {$wpdb->prefix}site_views WHERE YEAR(view_date)=%d", intval(current_time('Y'))));
    ...
    #clm-live .ver{opacity:.45;font-size:10px;letter-spacing:.02em}
    .clm-dropdown .ver-line{display:block;padding:.3rem .7rem;border-top:1px solid rgba(255,255,255,.12);margin-top:.25rem;
      color:rgba(255,255,255,.45);font-size:9px;letter-spacing:.06em;text-align:center}
    .clm-dropdown{position:absolute;top:calc(100% + 6px);right:0;width:100%;
    ...
    <div id="clm-live" title="Live Cursors v2026.09.13"><div id="clm-live-inner"><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><g transform="rotate(-20 12 12)"><path d="M5.5 3.21V20.8c0 .45.54.67.85.35l4.86-4.86a.5.5 0 0 1 .35-.15h6.87a.5.5 0 0 0 .35-.85L6.35 2.85a.5.5 0 0 0-.85.35Z" fill="#fff" stroke="none"></path></g></svg><span id="clm-live-count">1</span> en ligne<span class="sep">·</span><a href="<?php echo esc_url($stats_url); ?>"><?php echo number_format_i18n($year_total); ?> vues</a><span class="sep">·</span><span class="ver">v2026.09.13</span></div><div class="clm-dropdown" id="clm-dropdown"></div></div>
    <script>
    (function(){
      ...
      function updateDropdown(){
        ...
        html+='<span class="ver-line">Live Cursors v2026.09.13</span>';
