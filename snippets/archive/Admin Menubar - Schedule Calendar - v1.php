 ...
 * Source path: WP_Snippets_Online_Current/inactive/admin/001__id-5__admin-schedule-calendar.php
 * Display name: ADMIN - Schedule Calendar
 * Scope: admin
 * Online snippet: oui
 * Online active: non
 * Online ID: 5
 * Online modified: 2025-01-24 13:36:30
 * Online revision: 18
 * Exact duplicate group: non
 * Version family: ADMIN - Schedule Calendar (1 variantes)
 * Version: v1
 * Recommended latest in family: WP_Snippets_Online_Current/inactive/admin/001__id-5__admin-schedule-calendar.php
 ...
 * Hooks WP: admin_enqueue_scripts, admin_head, admin_menu, admin_bar_menu
 * Fonctions clefs: add_calendar_scripts, scheduled_posts_calendar_styles_alpha, get_posts_years_range, generate_scheduled_posts_calendar_alpha, updateCalendar, generateCalendarGrid, updateMonthlyStats, updateSelectorsAndCalendar
 * Lignes / octets (brut): 706 / 26046
 * Hash code normalise (sha256): d3ed4353f1bfcf88a7b1d4c5e1105c52ffc15075550f04890cbc4af73764a35c
 * Genere le (UTC): 2026-02-24T16:05:10+00:00
 */

/* CLM-FEATURES-DESCRIPTION:START
 * Fichier: admin-schedule-calendar__v001.php
 * Path: WP_Snippets_FINAL_CLEAN/archive/admin-schedule-calendar__v001.php
 * Resume fonctionnalites: customisation interface admin, interface de recherche, UI frontend (CSS/HTML), automatisation date/programmation, 4 hook(s) WP, 8 fonction(s) clef
 ...
 * Hooks WP: admin_enqueue_scripts, admin_head, admin_menu, admin_bar_menu
 * Fonctions clefs: add_calendar_scripts, scheduled_posts_calendar_styles_alpha, get_posts_years_range, generate_scheduled_posts_calendar_alpha, updateCalendar, generateCalendarGrid, updateMonthlyStats, updateSelectorsAndCalendar
 * Selecteurs / IDs: .post-item
 * APIs WP detectees: add_calendar_scripts, wp_enqueue_script, add_action, get_current_screen, get_posts_years_range, get_row, get_categories, rest_url, wp_create_nonce, admin_url, add_submenu_page, add_node
 * Signatures contenu: inline-style, inline-script, html-markup
 * Lignes / octets: 718 / 26825
 * Empreinte code (sha256): cbffd664bb4263272167bae1ba2b134b7b4e6a460de9539621a864538b020a6a
