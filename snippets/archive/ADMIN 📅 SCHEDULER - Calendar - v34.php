<?php
/*
 * Display name: ADMIN 📅 SCHEDULER - Calendar - v34
 * Scope: global
 */
...
function scheduled_posts_calendar_styles_alpha() {
    ...
    <style>
        ...
        .calendar-header {
            ...
            display: grid;
            grid-template-columns: minmax(220px, 1fr) auto minmax(170px, 220px) auto;
            gap: 8px 12px;
            align-items: center;
            background: #fbfbfc;
            padding: 10px 12px;
        ...
        /* V34: toolbar homogène et statistiques explicites. */
        .calendar-actions {
            display: flex;
            align-items: center;
            margin-left: 2px;
        ...
        .calendar-actions #reallocateDrafts:hover {
            background: #dbeafe;
            border-color: #2271b1;
            color: #0a4b78;
        }
...
function generate_scheduled_posts_calendar_alpha() {
    ?>
    <div class="wrap">
        <h1>Calendrier <span style="font-size:0.55em;font-weight:600;color:#2271b1;vertical-align:middle;background:#e8f0fe;padding:2px 8px;border-radius:999px;margin-left:6px;">v34</span></h1>
