<?php
/*
 * Display name: ADMIN 📅 SCHEDULER - Calendar - v24
 * Scope: global
 */
...
function generate_scheduled_posts_calendar_alpha() {
    ?>
    <div class="wrap">
        <h1>Calendrier <span style="font-size:0.55em;font-weight:600;color:#2271b1;vertical-align:middle;background:#e8f0fe;padding:2px 8px;border-radius:999px;margin-left:6px;">v23</span></h1>
        ...
        if (reallocateDraftsButton && reallocateDialog) {
            ...
            reallocateConfirm.addEventListener('click', function() {
                ...
                .then(data => {
                    ...
                    // V23: debug — occupation des 5 prochains jours
...
function clm_reallocate_overdue_posts_ajax() {
    ...
    // V23: debug — occupation des 5 prochains jours à partir de demain
    $debug_occupancy = array();
    $debug_day = clone $tomorrow;
    for ( $i = 0; $i < 5; $i++ ) {
