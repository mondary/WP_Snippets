<?php
/*
 * Display name: FRONTEND 📊 CURSOR - Live Cursors - 2026.09.8
 * Scope: global
 */
...
function clm_cursor_footer_js() {
    ...
    global $wpdb;
    $all_total = (int) $wpdb->get_var("SELECT SUM(views) FROM {$wpdb->prefix}site_views");
    ...
    <div id="clm-live"><div id="clm-live-inner"><svg viewBox="0 0 24 24" fill="none" aria-hidden="true"><g transform="rotate(-20 12 12)"><path d="M5.5 3.21V20.8c0 .45.54.67.85.35l4.86-4.86a.5.5 0 0 1 .35-.15h6.87a.5.5 0 0 0 .35-.85L6.35 2.85a.5.5 0 0 0-.85.35Z" fill="#fff" stroke="none"></path></g></svg><span id="clm-live-count">1</span> en ligne<span class="sep">·</span><a href="<?php echo esc_url($stats_url); ?>"><?php echo number_format_i18n($all_total); ?> vues</a></div><div class="clm-dropdown" id="clm-dropdown"></div></div>
    <script>
    (function(){
