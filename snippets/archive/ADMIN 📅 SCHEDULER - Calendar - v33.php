<?php
/*
 * Display name: ADMIN 📅 SCHEDULER - Calendar - v33
 * Scope: global
 */
...
function generate_scheduled_posts_calendar_alpha() {
    ?>
    <div class="wrap">
        <h1>Calendrier <span style="font-size:0.55em;font-weight:600;color:#2271b1;vertical-align:middle;background:#e8f0fe;padding:2px 8px;border-radius:999px;margin-left:6px;">v33</span></h1>
          ...
          <div class="calendar-topbar">
            <div class="calendar-header">
                ...
                <div class="calendar-stats">
                    <span title="Total annuel : publiés, planifiés et brouillons (filtre catégorie inclus)"><i class="dashicons dashicons-calendar-alt"></i> <span id="totalYearPosts" class="count">0</span></span>
                    <span title="Articles du mois sélectionné : publiés, planifiés et brouillons (filtre catégorie inclus)"><i class="dashicons dashicons-calendar"></i> <span id="totalMonthPosts" class="count">0</span></span>
                    <span title="Moyenne mensuelle : total annuel ÷ 12 (filtre catégorie inclus)"><i class="dashicons dashicons-chart-area"></i> <span id="avgPostsPerMonth" class="count">0</span></span>
                </div>
            </div>
