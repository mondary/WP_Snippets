<?php
/*
 * Display name: FRONTEND 🌸 FAB - Hub Flottant - v3
 * Scope: global
 */
 ...
 * en panneau lisible (carte responsive avec une ligne par action) :
 *
...
function mdhub_print_styles() {
    ...
    <style>
        ...
        #mdhub-main .mdhub-main-icon {
            font-size: 22px;
            transition: transform 0.45s cubic-bezier(0.34, 1.56, 0.64, 1);
        }
        #mdhub.is-open #mdhub-main .mdhub-main-icon { transform: rotate(135deg); }

        /* ---- Panneau d'actions : une ligne lisible par action ---- */
        #mdhub-petals {
            position: fixed;
            right: 22px;
            bottom: 92px;
        ...
        @media screen and (max-width: 600px) {
            ...
            #mdhub-petals { right: 16px; bottom: 78px; width: calc(100vw - 32px); max-height: min(70vh, 520px); overflow-y: auto; }
            .mdhub-item { min-height: 48px; }
        ...
        @media (prefers-reduced-motion: reduce) {
            ...
            #mdhub-main, #mdhub-main .mdhub-main-icon,
