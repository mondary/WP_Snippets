<?php
/*
 * Display name: FRONTEND 🌸 FAB - Hub Flottant - v14
 * Scope: global
 */
 ...
 * Historique : v14 = meme contenu que v13 (burger anime stack->cube, toast
 * elargi, z-index GT/petals, fond blanc GT supprime) publie sous un nouveau
 * numero car la v13 avait ete modifiee apres installation ; v13 = burger
 * anime stack->cube (geometrie d'apres iconmonstr
...
function mdhub_print_styles() {
    ...
    <style>
        ...
        .mdhub-main-icons { position: relative; display: block; width: 24px; height: 24px; }
        ...
        <div id="mdhub-dock">
            ...
            <span class="mdhub-main-icons" aria-hidden="true">
                <svg class="mdhub-ico-stack" viewBox="0 0 24 24" fill="currentColor" focusable="false">
                    <path d="M12 2.8 21.5 5.6 12 8.4 2.5 5.6z"/>
                    <path d="M12 9.2 21.5 12 12 14.8 2.5 12z"/>
                    <path d="M12 15.6 21.5 18.4 12 21.2 2.5 18.4z"/>
                </svg>
                <svg class="mdhub-ico-cube" viewBox="0 0 24 24" fill="currentColor" focusable="false">
                    <path d="M12 2 22 7.1 12 12.2 2 7.1z"/>
                    <path d="M2.6 8.55 11 13.1 11 21.9 2.6 17.35z"/>
                    <path d="M13 13.1 21.4 8.55 21.4 17.35 13 21.9z"/>
                </svg>
            </span>
            </button>
