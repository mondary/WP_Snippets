<?php
/*
 * Display name: FRONTEND 🌸 FAB - Hub Flottant - v10
 * Scope: global
 */
 ...
 *   - 🧭 ADMIN MENUBAR - Futur Menubar v4 : RESTE ACTIF (futur site
 *     /?future_site=1 : acces premium + bandeau spoiler, paywall sinon)
 *
 * Historique : v10 = ligne "Articles programmés" cliquable vers le futur
 * site (/?future_site=1, gere par Futur Menubar v4) ; v9 = switcher
 * GTranslate aligne sur la geometrie des items + jauge 18px ; v8 =
