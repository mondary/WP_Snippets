<?php
/*
 * Display name: FRONTEND 🌸 FAB - Hub Flottant - v2
 * Scope: global
 */
 ...
 * en menu colonne verticale (speed-dial : items empiles au-dessus du bouton,
 * labels alignes a gauche ; les 8 actions restent lisibles d'un coup d'oeil) :
 *
...
function mdhub_print_styles() {
    ...
    <style>
        ...
        /* ---- Items : colonne verticale (speed-dial, un seul rayon) ---- */
        .mdhub-item {
            position: absolute;
            right: 6px;
            bottom: calc(64px + var(--i) * 52px);
            width: 46px;
            height: 46px;
            margin: 0;
            border-radius: 50%;
        ...
        @media screen and (max-width: 600px) {
            ...
            .mdhub-item { width: 42px; height: 42px; right: 5px; bottom: calc(58px + var(--i) * 48px); }
