 ...
 * Source path: WP_Snippets_Online_Current/inactive/global/071__id-131__admin-cli-schedule-14-00.php
 * Display name: ADMIN - CLI schedule 14:00
 * Scope: global
 * Online snippet: oui
 * Online active: non
 * Online ID: 131
 * Online modified: 2025-08-27 12:21:43
 * Online revision: 5
 * Exact duplicate group: non
 * Version family: ADMIN - CLI schedule 14:00 (1 variantes)
 * Version: v1
 * Recommended latest in family: WP_Snippets_Online_Current/inactive/global/071__id-131__admin-cli-schedule-14-00.php
 * Is family latest: oui
 * Canonical reasons: unique-code
 * Features: snippet-php
 * Dependances probables: WordPress core hooks
 * Hooks WP: wp_insert_post, admin_notices
 * Fonctions clefs: auto_schedule_posts_14h, find_next_available_slot, show_auto_schedule_notice
 * Lignes / octets (brut): 158 / 5955
 * Hash code normalise (sha256): 65fd0f6ead826e7ae85fc86fbd0f44a6f6240504bbe7207e38f0b91a7fec3171
 * Genere le (UTC): 2026-02-24T16:05:10+00:00
 */

/* CLM-FEATURES-DESCRIPTION:START
 * Fichier: INACTIVE__global__admin-cli-schedule-14-00__v1__src-wp_snippets_online_current.php
 * Path: WP_Snippets_FINAL_CLEAN/canonical/INACTIVE__global__admin-cli-schedule-14-00__v1__src-wp_snippets_online_current.php
 ...
 * Lignes / octets: 170 / 6531
 * Empreinte code (sha256): 757bdccb3eeda76de4c7f043dbafcafa2bd2c79b1ed9084e62998d4213bd920f
 ...
 * 1. Detecting new posts created via XML-RPC or admin
 * 2. Finding the next available weekday slot at 14:00
 * 3. Updating the post schedule automatically
 * 
 * Installation:
 * 1. Go to WordPress Admin → WPCode → Code Snippets
 * 2. Add new PHP snippet
 * 3. Paste this entire code
 * 4. Title: "Auto Schedule Posts 14:00 Weekdays"
 * 5. ACTIVATE the snippet
 */

if (!function_exists('auto_schedule_posts_14h')) {
    
    /**
     * Hook into post creation/update to handle scheduling
     * This hook triggers for both XML-RPC and admin posts
     */
    add_action('wp_insert_post', 'auto_schedule_posts_14h', 10, 3);
    
    function auto_schedule_posts_14h($post_id, $post, $update) {
        ...
        $scheduled_datetime = find_next_available_slot();
     ...
     */
    function find_next_available_slot() {
     ...
     */
    add_action('admin_notices', 'show_auto_schedule_notice');
    
    function show_auto_schedule_notice() {
        global $pagenow, $post;
