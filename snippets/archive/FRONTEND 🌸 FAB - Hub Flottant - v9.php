<?php
/*
 * Display name: FRONTEND 🌸 FAB - Hub Flottant - v9
 * Scope: global
 */
 ...
 *
 * Historique : v9 = switcher GTranslate aligne sur la geometrie exacte des
 * items (meme padding gauche, drapeau 18px aligne sur les icones, texte
 * 12px/650 aligne sur les labels, ligne de 40px, hover uniforme) ; v8 =
 * masquage du bouton flottant newsletter .wppk-floating-newsletter-btn
 * (HTML+CSS injecte cote WP hors repo — pas Jetpack, pas un snippet local ;
 * l'item Newsletter de la stack le remplace) ; v7 = item "Lire en
 * diaporama" + masquage du bouton play #np-fab ; v6 = infos "articles
 * programmés" inline + Newsletter vers /newsletter/ ; v5 = rebasage sur
 * les scripts dedies ; Flux RSS et Retour en haut retires.
 *
...
function mdhub_print_styles() {
    ...
    <style>
        ...
        .mdhub-item.mdhub-info { min-height: 40px; cursor: default; }
