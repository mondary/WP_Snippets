<?php
/*
 * Display name: FRONTEND 🌸 FAB - Hub Flottant - v8
 * Scope: global
 */
 ...
 *
 * Historique : v8 = masquage du bouton flottant newsletter .wppk-floating-
 * newsletter-btn (HTML+CSS injecte cote WP hors repo — pas Jetpack, pas un
 * snippet local ; l'item Newsletter de la stack le remplace) ; v7 = item
 * "Lire en diaporama" + masquage du bouton play #np-fab ; v6 = infos
 * "articles programmés" inline + Newsletter vers /newsletter/ ; v5 =
 * rebasage sur les scripts dedies (retrait endpoint REST, overlay et
 * masquage #kt-scroll-up) ; Flux RSS et Retour en haut retires.
 *
