 ...
 * Source path: WP_Snippets/WP_POST - Scheduled Posts Gauge 5.php
 * Display name: WP_POST - Scheduled Posts Gauge 5
 * Scope: front-end
 * Online snippet: non
 ...
 * Lignes / octets (brut): 232 / 13347
 * Hash code normalise (sha256): 02799a442a72774d047ccfda0579af8e91ad284d3676ed638c8a72036e1c4572
 * Genere le (UTC): 2026-02-24T16:05:10+00:00
 */

/* CLM-FEATURE-CLASSIFICATION:START
 * Fichier: post-scheduled-posts-gauge__v005.php
 * Path: WP_Snippets_FINAL_CLEAN/archive/post-scheduled-posts-gauge__v005.php
...
e_script, wp_send_json_error, get_option, wp_send_json_success
 * Signatures contenu: php-open-tag, inline-style, inline-script, html-markup
 * Lignes / octets: 255 / 14486
 * Empreinte code (sha256): 453892ed832881038b2a517de6126fe23174eb614726b47adc1d6f3b3d2f203f
...
add_action('wp_ajax_clm_handle_patreon_poll', 'clm_handle_patreon_poll_v5_callback');
add_action('wp_ajax_nopriv_clm_handle_patreon_poll', 'clm_handle_patreon_poll_v5_callback');
...
add_action('wp_ajax_clm_get_patreon_poll_results', 'clm_get_patreon_poll_results_v5_callback');
add_action('wp_ajax_nopriv_clm_get_patreon_poll_results', 'clm_get_patreon_poll_results_v5_callback');
