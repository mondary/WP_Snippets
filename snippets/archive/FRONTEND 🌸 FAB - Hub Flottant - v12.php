<?php
/*
 * Display name: FRONTEND 🌸 FAB - Hub Flottant - v12
 * Scope: global
 */
 ...
 *
 * Toast promotionnel : carte a pastille coloree (label + texte) a cote du FAB
 * apres ~3,5s ; tirage sans repetition (ordre de Fisher-Yates persiste en
 * localStorage) ; cliquable, auto-masquee apres 10s, fermable (silence 30 min).
 * Le burger devient un « + » qui pivote en croix quand la stack est ouverte.
 *
 ...
 * Historique : v12 = toast redessine (pastille coloree + label de feature),
 * tirage sans repetition (Fisher-Yates persiste), burger « + » pivotant en
 * croix ; v11 = toast promotionnel + poignee ⇄ collee au burger ; v10 =
 * ligne "Articles programmés" vers le futur site ; v9 = alignements
 * GTranslate/jauge ; v8 = masquage .wppk-floating-newsletter-btn ; v7 =
 * item diaporama + masquage #np-fab ; v6 = Newsletter vers /newsletter/ ;
 * v5 = rebasage sur les scripts dedies.
 * masquage du bouton flottant newsletter .wppk-floating-newsletter-btn ;
 * v7 = item "Lire en diaporama" + masquage #np-fab ; v6 = Newsletter vers
 * /newsletter/ ; v5 = rebasage sur les scripts dedies ; Flux RSS et
 * Retour en haut retires.
 *
...
function mdhub_print_styles() {
    ...
    <style>
        ...
        #mdhub-main .mdhub-main-icon { transition: transform 0.3s ease; }
        #mdhub.is-open #mdhub-main .mdhub-main-icon { transform: rotate(45deg); }
        #mdhub-flip {
            width: 26px;
            height: 26px;
            border: 1px solid rgba(15, 23, 42, 0.10);
    ...
    <nav id="mdhub" aria-label="Menu du site">
        ...
        <div id="mdhub-dock">
            ...
            <button id="mdhub-main" type="button" aria-expanded="false" aria-controls="mdhub-petals" aria-label="Ouvrir le menu du site">
                <i class="fa-solid fa-plus mdhub-main-icon" aria-hidden="true"></i>
            </button>
        </div>
