<?php
/*
 * Display name: FRONTEND 🌸 FAB - Hub Flottant - v15
 * Scope: global
 */
 ...
 * Burger anime : la stack de couches (d'apres iconmonstr layer-multiple-alt-
 * filled) se mue en cube (d'apres iconmonstr cube-filled) quand le menu
 * s'ouvre — crossfade a ressort, aucun pictogramme Font Awesome.
 *
 ...
 * Historique : v15 = icônes du burger pres de deux fois plus grandes (46px
 * sur un bouton de 52px, 40px en mobile) et losanges de la stack redessines
 * (plus epais, espacement regulier de 1.2, bien alignes) ; v14 = republication
 * de la v13 modifiee apres installation (burger anime stack->cube, toast
 * elargi, z-index GT/petals, fond blanc GT supprime) ; v13 = burger anime
 * stack->cube (geometrie d'apres iconmonstr
 * layer-multiple-alt-filled / cube-filled), toast elargi (min-width 300px,
 * z-index au-dessus du switcher GTranslate, petals au-dessus du toast), fond
 * blanc du wrapper GTranslate supprime (il masquait le toast) ; v12 = toast
 * redessine + tirage sans repetition + burger « + » ; v11 = toast
 * promotionnel + poignee ⇄ collee au burger ; v10 = ligne "Articles
 * programmés" vers le futur site ; v9 = alignements GTranslate/jauge ; v8 =
 * masquage .wppk-floating-newsletter-btn ; v7 = item diaporama + masquage
 * #np-fab ; v6 = Newsletter vers /newsletter/ ; v5 = rebasage scripts dedies.
 *
...
function mdhub_print_styles() {
    ...
    <style>
        ...
        .mdhub-ico-cube { opacity: 0; transform: rotate(-90deg) scale(0.4); }
        #mdhub.is-open .mdhub-ico-stack { opacity: 0; transform: rotate(90deg) scale(0.4); }
        #mdhub.is-open .mdhub-ico-cube { opacity: 1; transform: none; }
        #mdhub-flip {
            width: 26px;
            height: 26px;
            border: 1px solid rgba(15, 23, 42, 0.10);
    ...
    <nav id="mdhub" aria-label="Menu du site">
        ...
        <div id="mdhub-dock">
            ...
            <span class="mdhub-main-icons" aria-hidden="true">
                <svg class="mdhub-ico-stack" viewBox="0 0 24 24" fill="currentColor" focusable="false">
                    <path d="M12 0.9 21.5 4.2 12 7.5 2.5 4.2z"/>
                    <path d="M12 8.7 21.5 12 12 15.3 2.5 12z"/>
                    <path d="M12 16.5 21.5 19.8 12 23.1 2.5 19.8z"/>
                </svg>
                <svg class="mdhub-ico-cube" viewBox="0 0 24 24" fill="currentColor" focusable="false">
                    <path d="M12 1 23 6.7 12 12.4 1 6.7z"/>
                    <path d="M1.8 8.3 11 13.2 11 23 1.8 18.1z"/>
                    <path d="M13 13.2 22.2 8.3 22.2 18.1 13 23z"/>
                </svg>
            </span>
            </button>
