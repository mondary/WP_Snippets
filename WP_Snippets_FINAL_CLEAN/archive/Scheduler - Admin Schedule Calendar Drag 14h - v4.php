 ...
 * Fichier: ACTIVE__global__admin-schedule-calendar-drag-14h__v4__src-wp_snippets_online_current.php
 * Path: WP_Snippets_FINAL_CLEAN/canonical/ACTIVE__global__admin-schedule-calendar-drag-14h__v4__src-wp_snippets_online_current.php
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function buildDaySchedulePlan(posts, dayDate) {
            ...
            return sortedPosts.map((post, index) => {
                ...
                return {
                    id: post.id,
                    payloadDate: `${dayDate}T${formatPostHourLabel(hour)}`
                };
            });
        }
