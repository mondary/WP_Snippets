...
## 🧾 Changelog
- 2026-09-08: **Live Cursors `2026.09.12`** — real names when available: logged-in WP account, else the comment-author cookie name; otherwise a unique server-assigned "Anonyme N" remembered in localStorage (random fake first names removed, no more name collisions).
